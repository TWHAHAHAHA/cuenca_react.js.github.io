...
import hokImage from '../img/hok.jpg';
import CODImage from '../img/COD.jpg';

import kentImage from '../img/kentpp1.png';
          ...
          <div className="education-horizontal-timeline">
            <div className="row">
              ...
              <div className="col-md-4 text-center mb-3">
                <div className="single-horizontal-timeline">
                  ...
                  <div className="timeline text-center">
                    <div className="timeline-content">
                      <h4 className="title text-white">
                      Senior high- kabankalan catholic college
                      </h4>
                      <p className="text-secondary text-white">
              ...
              <div className="col-md-4 text-center mb-3">
                <div className="single-horizontal-timeline">
                  <div className="experience-time">
                    <h4 className="text-white">2013</h4>
                  </div>
                  <div className="timeline-horizontal-border">
                    <FontAwesomeIcon className="i" icon={faUnity} />
                  </div>
                  <div className="timeline text-center">
                    <div className="timeline-content">
                      <h4 className="title text-white">Daan-Banua elementary school</h4>
                      <p className="text-secondary text-white">
                        Brgy.Daan-Banua Kabankalan, Negros Occidental
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container text-center text-md-left">
          <div className="row text-center text-md-left">
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
              ...
              <p>
                <a
                  href="https://www.facebook.com/kent.cuenca.9"
              ...
              <p>
                <a
                  href="https://github.com/TWHAHAHAHA"
          ...
          <div className="row d-flex align-items-center">
            <div className="col-md-7 col-lg-8">
              <p className="text-center text-md-left">
                © 2023 Copyright <strong>Kent's</strong> All Rights Reserved
              </p>
            </div>
